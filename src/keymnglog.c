...
#define _DEBUG_FILE_	"keymngclient.log"
...
#ifdef WIN32
	sprintf(fileName, "c:\\log\\%s",_DEBUG_FILE_);
#else
	sprintf(fileName, "%s/WorkSpace/Project/myecmng/log/%s",getenv("HOME"), _DEBUG_FILE_);
#endif
